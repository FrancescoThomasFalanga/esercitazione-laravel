    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('wines.index') }}">Vini</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('wineries.index') }}">Cantine</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('vineyards.index')}}">Vigneti</a>
                </li>
            </ul>
